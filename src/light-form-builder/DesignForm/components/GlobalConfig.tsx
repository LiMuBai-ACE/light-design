...
const GlobalConfig: FC = () => {
  ...
  const handleGlobalConfigChange = <T extends keyof typeof globalConfig>(
    fieldName: T,
    value: (typeof globalConfig)[T],
  ) => {
    const action = {
  ...
  const handleFormConfigChange = <T extends keyof typeof formConfig>(
    fieldName: T,
    value: (typeof formConfig)[T],
  ) => {
    const action = {
          ...
          <Form layout="vertical">
            <Form.Item label="组件尺寸">
              <Radio.Group
                ...
                onChange={(event) =>
                  handleGlobalConfigChange('componentSize', event.target.value)
                }
              />
            </Form.Item>
            ...
            <Form.Item label="文本方向">
              <Radio.Group
                ...
                onChange={(event) =>
                  handleGlobalConfigChange('direction', event.target.value)
                }
              />
            </Form.Item>
            ...
            <Form.Item label="国际化">
              <Select
                ...
                value={globalConfig.locale?.locale}
            ...
            <Form.Item label="Icon地址">
              <Input
                placeholder="Iconfont Symbol"
                value={iconSrc}
                onChange={(event) => handleIconSrcChange(event.target.value)}
              />
            </Form.Item>
            ...
            <Form.Item label="表单布局">
              <Radio.Group
                ...
                onChange={(event) =>
                  handleFormConfigChange('layout', event.target.value)
                }
              />
            </Form.Item>
            ...
            <Form.Item label="标签对齐方式">
              <Radio.Group
                ...
                onChange={(event) =>
                  handleFormConfigChange('labelAlign', event.target.value)
                }
              />
            </Form.Item>
            ...
            <Form.Item label="是否显示label后面的冒号">
              <Switch
                defaultChecked={formConfig.colon}
                onChange={(checked) => handleFormConfigChange('colon', checked)}
              />
            </Form.Item>

            <Form.Item label="标签文本换行方式">
              <Switch
                defaultChecked={formConfig.labelWrap}
                onChange={(checked) =>
                  handleFormConfigChange('labelWrap', checked)
                }
              />
            </Form.Item>
