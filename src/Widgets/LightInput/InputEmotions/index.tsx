...
export interface LightInputEmotionProps extends Omit<InputProps, 'onChange'> {
  emotions?: any[];
  onChange?: (value: string) => void;
}
const LightInputEmotions: FC<LightInputEmotionProps> = (props) => {
...
export default LightInputEmotions;
